...
function Library:CreateWindow(config)
    ...
    function window:CreateTab(name)
        ...
        -- Layout so elements stack vertically and move when sizes change
        ...
        function tab:AddToggle(config)
            ...
            toggle.Position = UDim2.fromOffset(10, 0) -- X padding only
        ...
        ----------------------------------------------------------------
        -- Add Selector (scrollable dropdown with arrow)
        ----------------------------------------------------------------
        function tab:AddSelector(config)
            ...
            container.Position = UDim2.fromOffset(10, 0)
            ...
            local itemHeight = 24
            local maxVisibleHeight = 150 -- max visible dropdown height
            ...
            local function setOpen(state)
                ...
                if open then
                    ...
                    currentTween = TweenService:Create(
                        listFrame,
                        dropdownTweenInfo,
                        { Size = UDim2.fromOffset(340, getDropdownHeight()) }
                    )
                    currentTween:Play()
                else
                    currentTween = TweenService:Create(
