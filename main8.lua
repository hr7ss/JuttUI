...
function Library:CreateWindow(config)
    ...
    function window:CreateTab(name)
        ...
        -- Padding so everything has the same left/right margin
        local contentPadding = Instance.new("UIPadding")
        contentPadding.PaddingLeft = UDim.new(0, 10)
        contentPadding.PaddingRight = UDim.new(0, 10)
        contentPadding.Parent = content

        -- Vertical layout so items stack and auto-move
        ...
        ------------------------------------------------------------
        -- Add Selector (scrollable dropdown, full width, aligned)
        ------------------------------------------------------------
        function tab:AddSelector(config)
            ...
            local itemHeight = 24
            local maxVisibleHeight = 150 -- max dropdown height
